...
def get_args_parser():
    ...
    # parser.add_argument('--resume', default='model/checkpoint0299.pth', help='resume from checkpoint')
    parser.add_argument('--resume', default='', help='Dont resume from checkpoint')
