...
import torch
from src.training_utils.util.data_utils import data_to_cuda, delete_graphs, get_given_layers_random_region, get_random_region_targets, \
    draw_given_layers_on_tensors_random_region, initialize_tensors, random_keep, is_stop, draw_preds_on_tensors, edge_inside, point_inside, \
    remove_points, remove_edge, get_edges_amount
from src.training_utils.util.graph_utils import tensors_to_graphs_batch, get_cycle_basis_and_semantic, get_cycle_basis_and_semantic_2
from src.training_utils.util.metric_utils import calculate_single_sample
from src.training_utils.util.edges_utils import get_edges_alldirections
from src.training_utils.util.misc import NestedTensor
from src.training_utils.util.visualize_utils import visualize_monte


def train_one_epoch(task, model, criterion, data_loader, optimizer, epoch, max_norm, args):
